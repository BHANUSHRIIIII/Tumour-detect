...
import numpy as np
from tensorflow.keras.applications import ResNet50 # Updated to ResNet50
...
image_generator = ImageDataGenerator(
    rescale=1./255,
    horizontal_flip=True,  # Changed from 2 to True
    vertical_flip=True,    # Changed from 2 to True
...
# Model: ResNet50 instead of VGG19
model = ResNet50(
